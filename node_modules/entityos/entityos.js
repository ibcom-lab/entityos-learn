...
module.exports = 
{
	...
	init: function (callBack, settings)
	{
		...
		{	
			...
			{
				if (_.has(module.exports.data, '_event.site'))
				{
					siteSuffix = '-' + module.exports.data._event.site;
				}

				if (_.has(module.exports.data, '_event.context'))
				{
					siteSuffix = '-' + module.exports.data._event.context;
				}

				if (_.has(module.exports.data, '_event.space'))
				{
					siteSuffix = '-' + module.exports.data._event.space;
				}
			}
